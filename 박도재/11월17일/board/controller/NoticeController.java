...
public class NoticeController {
    ...
    public String detail(@PathVariable int id, Model model) {
        ...
        return "board/noticeDetail"; // 템플릿 추가 예시(아래 참고)
    }
    /* 삭제 API - 추가 */
    @DeleteMapping("/api/board/notice/{id}")
    @ResponseBody
