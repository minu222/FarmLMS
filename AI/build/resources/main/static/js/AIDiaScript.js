// /js/AIDiaScript.js (AI 진단 기능 + 원본 헤더 스크롤 기능)
...
function displayPlantIDInfo(plantIdResponse, base64Image) {
    ...
    if (plantHealthStatus === true) {
        ...
        if (diseaseSuggestion) {
            ...
            // 진단 확률은 백분율로 표시
            diseaseProbabilityContainer.innerHTML = `<p><strong>진단 확률:</strong> ${(diseaseSuggestion.probability.toFixed(4) * 100).toFixed(2)}%</p>`;
