...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='모든 사용자(관리자, 강사, 일반유저)';
...
INSERT INTO `all_users` (`user_id`, `user_type`, `id`, `password`, `name`, `nickname`, `birth`, `email`, `intro`) VALUES
	...
	(17, 'student', '1234', '1234', 'test', '학생', '2025-11-14', 'asd@123d.d', NULL),
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='채팅방 사용자';
...
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='채팅 기록';
...
CREATE TABLE IF NOT EXISTS `game_session` (
  ...
  `game_status` enum('진행중','클리어') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT '진행중' COMMENT '게임 상태',
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='강의 QnA';
...
INSERT INTO `lecture_qna` (`qna_id`, `lecture_id`, `user_id`, `p_qna_id`, `content`, `created_at`) VALUES
	...
	(5, 2, 1, NULL, 'ㅇ', '2025-11-17 08:04:52'),
	(6, 2, 1, NULL, '5', '2025-11-17 08:07:04');
...
CREATE TABLE IF NOT EXISTS `quiz_attempt` (
  ...
  `grading_status` enum('채점대기','채점완료') NOT NULL DEFAULT '채점대기' COMMENT '채점 상태',
...
CREATE TABLE IF NOT EXISTS `quiz_score` (
  ...
  `earned_point` int NOT NULL DEFAULT '0' COMMENT '획득 포인트',
  `pass` enum('합격','불합격') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '불합격' COMMENT '합격/불합격',
...
BEGIN
    ...
    IF v_current_total >= v_pass_score THEN
        SET v_is_pass = '합격';
        SET v_point_change = v_current_total;  -- 합격 시 총점만큼 포인트 획득
    ELSE
        SET v_is_pass = '불합격';
        SET v_point_change = 0;
    END IF;
    ...
    -- 8. 합격한 경우에만 포인트 지급
    IF v_is_pass = '합격' AND v_point_change > 0 THEN
        -- 현재 포인트 조회
        SELECT COALESCE(MAX(total_point), 0) INTO v_current_point
        FROM point
        ...
        INSERT INTO point (
            ...
            v_existing_score_id,
            v_point_change,
            v_current_point + v_point_change,
            NOW()
        );
    END IF;
    ...
    SELECT 
        ...
        v_point_change AS earned_point,
