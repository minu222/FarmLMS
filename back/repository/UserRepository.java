package com.lms.urbangreen.urbangreenproject.user.repository;
...
public class UserRepository {
    ...
    public User findByNameAndEmail(String name, String email) {
        String sql = "SELECT * FROM all_users WHERE name = ? AND email = ?";
        try {
            return jdbcTemplate.queryForObject(sql, userRowMapper, name, email);
        } catch (EmptyResultDataAccessException e) {
            return null;
        }
    }
    ...
    public User findByIdAndEmail(String id, String email) {
        String sql = "SELECT * FROM all_users WHERE id = ? AND email = ?";
        try {
            return jdbcTemplate.queryForObject(sql, userRowMapper, id, email);
        } catch (EmptyResultDataAccessException e) {
            return null;
        }
    }
